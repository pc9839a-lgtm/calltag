...
const OG_IMAGE='https://calltag.pagero.kr/assets/calltag-og-20260805.png';
...
export default {
  async fetch(request,env){
    ...
    if(isLegal){
      headers.set('x-calltag-worker','v92-runtime-loader');
      return new Response(await response.text(),{status:response.status,statusText:response.statusText,headers,encodeBody:'automatic'});
    }
    ...
    body=body
      ...
      .replace('</body>','<script src="/assets/calltag-runtime-loader.js?v=20260807-runtime2"></script></body>');
