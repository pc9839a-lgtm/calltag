...
public final class PostCallExclusionStore {
    ...
    public static synchronized Entry find(Context context, String phone) {
    ...
    private static Map<String, Entry> readMap(Context context) {
        ...
        try {
            ...
            // Corrupt local data safely falls back to an empty exclusion list.
        }
        return result;
    }
    ...
    private static void write(Context context, Iterable<Entry> entries) {
        ...
        for (Entry entry : entries) {
            try {
                ...
                // Primitive values do not normally fail JSON serialization.
            }
        }
