(()=>{
  ...
  const run=()=>{
    ...
    if(targets&&viewport&&!viewport.classList.contains('ct-marquee-viewport')){
      ...
      if(cards.length){
        viewport.className='ad-targets ct-marquee-viewport';viewport.removeAttribute('style');
    ...
    if(!q('style[data-ct-interaction-fix]')){
      const style=document.createElement('style');style.dataset.ctInteractionFix='1';style.textContent=`
        ...
        #targets .ad-head{max-width:none!important}#targets .ad-title{white-space:nowrap!important;font-size:clamp(42px,5.2vw,76px)!important}#targets .ct-marquee-viewport{position:relative!important;display:block!important;width:100%!important;max-width:none!important;margin:0!important;overflow:hidden!important;scroll-snap-type:none!important;mask-image:linear-gradient(90deg,transparent 0,#000 7%,#000 93%,transparent 100%);-webkit-mask-image:linear-gradient(90deg,transparent 0,#000 7%,#000 93%,transparent 100%)}#targets .ct-marquee-rail{display:flex;width:max-content;will-change:transform;animation:ctIndustryFlow 34s linear infinite}#targets .ct-marquee-viewport:hover .ct-marquee-rail{animation-play-state:paused}#targets .ct-marquee-group{display:flex;flex:none;gap:20px;padding-right:20px}#targets .ct-marquee-group .ad-target{flex:0 0 clamp(420px,42vw,650px)!important;width:clamp(420px,42vw,650px)!important;min-height:330px!important;padding:48px 52px!important;border-radius:27px!important;display:flex!important;flex-direction:column!important;justify-content:center!important}#targets .ct-marquee-group .ad-target h3{margin-top:24px!important;font-size:clamp(32px,3.5vw,48px)!important;line-height:1.08!important}#targets .ct-marquee-group .ad-target b{margin-top:36px!important;font-size:15px!important}@keyframes ctIndustryFlow{from{transform:translate3d(0,0,0)}to{transform:translate3d(-50%,0,0)}}
        @media(max-width:700px){#targets .ad-title{font-size:clamp(29px,9vw,43px)!important}#targets .ct-marquee-group{gap:14px;padding-right:14px}#targets .ct-marquee-group .ad-target{flex-basis:82vw!important;width:82vw!important;min-height:290px!important;padding:34px 28px!important}#targets .ct-marquee-rail{animation-duration:28s}}@media(prefers-reduced-motion:reduce){#targets .ct-marquee-viewport{overflow-x:auto!important;mask-image:none;-webkit-mask-image:none}#targets .ct-marquee-rail{animation:none!important}}
