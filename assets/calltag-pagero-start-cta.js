(()=>{
  ...
  const mount=()=>{
    ...
    cta.innerHTML=`
      <small>고객 문의를 받을 랜딩페이지가 필요하신가요?</small>
      <a href="https://pagero.kr/app" class="ct-pagero-bottom-cta-btn" aria-label="페이지로 무료로 시작하기">페이지로 무료로 시작하기</a>
    `;
    ...
    if(!document.querySelector('style[data-ct-pagero-bottom-cta]')){
      ...
      style.textContent=`
        ...
        .ct-pagero-bottom-cta>small{display:block;color:#aab4c6;font-size:14px;font-weight:750;letter-spacing:-.02em}
        ...
        @media(max-width:640px){.ct-pagero-bottom-cta{gap:11px;margin-top:28px}.ct-pagero-bottom-cta>small{max-width:280px;font-size:13px;line-height:1.5}.ct-pagero-bottom-cta-btn{width:min(100%,280px);min-width:0;min-height:56px;padding:0 22px;font-size:17px}}
