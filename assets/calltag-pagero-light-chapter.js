(()=>{
  if(document.documentElement.dataset.ctPageroLightChapterV2)return;
  document.documentElement.dataset.ctPageroLightChapterV2='1';

  const mount=()=>{
    const intro=document.querySelector('#ct-pagero-intro');
    const hero=intro?.querySelector('.ct-v8-hero');
    if(!intro||!hero)return false;

    let brandIntro=intro.querySelector('.ct-pagero-brand-intro');
    if(!brandIntro){
      brandIntro=document.createElement('section');
      brandIntro.className='ct-pagero-brand-intro';
      brandIntro.innerHTML=`
        <div class="wrap ct-pagero-brand-intro-wrap">
          <p>페이지로</p>
          <h2>누구나 쉽게 제작하는<br><span>노코드 랜딩페이지.</span></h2>
          <strong>PAGERO</strong>
        </div>
      `;
      hero.insertAdjacentElement('beforebegin',brandIntro);
    }

    const duplicateLabels=[...intro.querySelectorAll('.ct-pagero-connect p,.ct-pagero-connect small,.ct-pagero-connect span,.ct-pagero-connect strong')]
      .filter(node=>(node.textContent||'').replace(/\s+/g,' ').trim().toUpperCase()==='PAGERO × CALLTAG');
    duplicateLabels.forEach(node=>node.style.setProperty('display','none','important'));

    return true;
  };

  const style=document.createElement('style');
  style.dataset.ctPageroLightChapter='2';
  style.textContent=`
    #ct-pagero-intro .ct-pagero-brand-intro,
    ...
    #ct-pagero-intro .ct-pagero-brand-intro{
      ...
      background:
        radial-gradient(circle at 50% 12%,rgba(70,105,235,.18),transparent 36%),
        linear-gradient(180deg,#ffffff 0%,#f6f8fc 70%,#eef2f8 100%)!important;
      overflow:hidden!important;
    }
    #ct-pagero-intro .ct-pagero-brand-intro:after{
      content:'';
      position:absolute;
      left:50%;
      bottom:-220px;
      ...
      border:1px solid rgba(49,93,221,.12);
      border-radius:50%;
      box-shadow:0 0 0 70px rgba(49,93,221,.035),0 0 0 140px rgba(49,93,221,.02);
      pointer-events:none;
    }
    #ct-pagero-intro .ct-pagero-brand-intro-wrap{
      position:relative;
      z-index:2;
      width:100%;
      text-align:center;
    }
    #ct-pagero-intro .ct-pagero-brand-intro p{
    ...
    #ct-pagero-intro .ct-pagero-brand-intro h2{
      max-width:1100px;
    ...
    #ct-pagero-intro .ct-pagero-brand-intro h2 span{
      color:#315ddd!important;
    }
    #ct-pagero-intro .ct-pagero-brand-intro strong{
      display:block;
      margin-top:42px;
      color:#cbd5e6;
    ...
    #ct-pagero-intro .ct-v8-head>strong em{color:#315ddd!important}
    ...
    #ct-pagero-intro .ct-v8-msg strong{color:#ffffff!important}
    ...
    #ct-pagero-intro .ct-pagero-connect .ct-connect-copy strong{color:var(--ct-light-muted)!important}
    ...
    @media(max-width:760px){
      #ct-pagero-intro .ct-pagero-brand-intro{
        ...
        padding:88px 18px 82px!important;
        border-top-width:8px!important;
      }
      #ct-pagero-intro .ct-pagero-brand-intro h2{font-size:clamp(42px,12vw,61px)!important}
      #ct-pagero-intro .ct-pagero-brand-intro strong{margin-top:32px;font-size:clamp(62px,22vw,106px)}
      #ct-pagero-intro .ct-v8-hero{padding-top:104px!important}
      #ct-pagero-intro .ct-pagero-connect{
        padding-top:86px!important;
        padding-bottom:96px!important;
        border-bottom-width:8px!important;
      }
      #ct-pagero-intro .ct-connect-demo{padding:24px 14px 28px!important;border-radius:24px!important}
    }
