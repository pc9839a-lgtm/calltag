(()=>{
  if(document.documentElement.dataset.ctHorizontalCompact)return;
  document.documentElement.dataset.ctHorizontalCompact='1';
  ...
  const css=`
    ...
    @media(max-width:900px){
      ...
      .ct-horizontal-clean__sticky{position:relative!important;top:auto!important;height:auto!important;min-height:0!important;overflow:visible!important}
      .ct-horizontal-clean__progress{display:none}
      .ct-horizontal-clean__track{display:grid;transform:none!important;height:auto;will-change:auto}
      .ct-horizontal-clean__panel{width:100%;height:auto;min-height:0;display:grid;grid-template-columns:1fr;gap:22px;padding:48px 16px;border-bottom:1px solid rgba(255,255,255,.09)}
      .ct-horizontal-clean__copy{max-width:none;text-align:center}
      .ct-horizontal-clean__copy h2,.ct-horizontal-clean__copy h3{font-size:clamp(34px,9.2vw,44px)}
      .ct-horizontal-clean__visual{width:100%;max-width:430px;margin:0 auto}
      .ct-horizontal-industries-clean .ct-industry-card{width:min(100%,340px)!important}
      .ct-horizontal-industries-clean .ct-industry-phone{height:auto!important;min-height:0!important}
      .ct-j-scene-clean{width:100%;height:auto;min-height:430px;margin:0;border-radius:18px}
      .ct-j-phone{right:14px;width:220px}
    }
  `;

  const addStyle=()=>{
    const existing=document.querySelector('style[data-ct-horizontal-clean]');
    if(existing)existing.remove();
    const node=document.createElement('style');
    node.dataset.ctHorizontalClean='compact';
  ...
  const buildIndustries=()=>{
    ...
    section.style.height='230svh';
    section.innerHTML=`<div class="ct-horizontal-clean__sticky"><div class="ct-horizontal-clean__track"></div>${makeProgress(3)}</div>`;
    ...
    cards.forEach((card,index)=>{
      ...
      panel.innerHTML=`<div class="ct-horizontal-clean__copy"><h3>${industryTitles[index]}</h3></div><div class="ct-horizontal-clean__visual"></div>`;
  ...
  const journeyMarkup=`<section class="ct-horizontal-clean ct-journey-clean"><div class="ct-horizontal-clean__sticky"><div class="ct-horizontal-clean__track">
    <article class="ct-horizontal-clean__panel"><div class="ct-horizontal-clean__copy"><h2>문의가<br>들어옵니다.</h2></div><div class="ct-horizontal-clean__visual"><div class="ct-j-scene-clean"><div class="ct-j-windowbar"><i></i><i></i><i></i><span></span></div><div class="ct-j-body"><div class="ct-j-bigstatus"><div><small>새 상담 신청</small><strong>김민수 고객</strong></div><em>접수 완료</em></div><div class="ct-j-form"><div><span>연락처</span><b>010-1234-5678</b></div><div><span>문의 내용</span><b>보험 상담 요청</b></div><div><span>유입 페이지</span><b>보험료 진단 랜딩</b></div></div><div class="ct-j-complete">✓ 콜태그로 전달됐습니다.</div></div></div></div></article>
    <article class="ct-horizontal-clean__panel"><div class="ct-horizontal-clean__copy"><h2>앱에서<br>바로 뜹니다.</h2></div><div class="ct-horizontal-clean__visual"><div class="ct-j-scene-clean"><div class="ct-j-windowbar"><i></i><i></i><i></i><span></span></div><div class="ct-j-body"><div class="ct-j-bigstatus"><div><small>콜태그 고객함</small><strong>신규 문의 1</strong></div><em>지금</em></div><div class="ct-j-phone"><div class="ct-j-phone-screen"><div class="ct-j-phone-head"><b>CALLTAG</b><span>● 1</span></div><div class="ct-j-alert"><small>페이지로 신규 문의</small><b>김민수 고객</b><small>보험 상담 요청 · 지금</small></div><div class="ct-j-actions"><span>전화</span><span>문자</span><span class="on">고객카드</span></div><div class="ct-j-timeline"><div><i>✓</i><span><b>자동 등록 완료</b><small>연락처·문의 저장</small></span></div><div><i>!</i><span><b>오늘 할 일</b><small>신규 문의 확인</small></span></div></div></div></div></div></div></div></article>
    <article class="ct-horizontal-clean__panel"><div class="ct-horizontal-clean__copy"><h2>전화가 끝나면<br>정리도 끝.</h2></div><div class="ct-horizontal-clean__visual"><div class="ct-j-scene-clean"><div class="ct-j-windowbar"><i></i><i></i><i></i><span></span></div><div class="ct-j-body"><div class="ct-j-bigstatus"><div><small>통화 종료</small><strong>김민수 고객</strong></div><em>02:18</em></div><div class="ct-j-form"><div><span>고객 구분</span><b>신규 문의</b></div><div><span>상담 상태</span><b>견적 전달</b></div><div><span>다음 할 일</span><b>3일 뒤 연락</b></div></div><div class="ct-j-actions"><span>문자</span><span>일정</span><span class="on">저장</span></div></div></div></div></article>
    <article class="ct-horizontal-clean__panel"><div class="ct-horizontal-clean__copy"><h2>다시 연락할<br>고객만 보입니다.</h2></div><div class="ct-horizontal-clean__visual"><div class="ct-j-scene-clean"><div class="ct-j-windowbar"><i></i><i></i><i></i><span></span></div><div class="ct-j-body"><div class="ct-j-bigstatus"><div><small>오늘의 고객관리</small><strong>재연락 8건</strong></div><em>진행 중</em></div><div class="ct-j-stats"><article><small>신규</small><b>24</b></article><article><small>완료</small><b>17</b></article><article><small>예정</small><b>6</b></article></div><div class="ct-j-bars"><i></i><i></i><i></i><i></i><i></i><i></i></div><div class="ct-j-complete">✓ 후속관리까지 연결됐습니다.</div></div></div></div></article>
  ...
  const setup=sections=>{
    ...
    const render=()=>{
      ...
      metrics.forEach(item=>{
        ...
        item.track.style.transform=`translate3d(${-progress*(item.panels.length-1)*innerWidth}px,0,0)`;
        const index=Math.min(item.panels.length-1,Math.round(progress*(item.panels.length-1)));
        item.panels.forEach((panel,i)=>panel.classList.toggle('is-active',i===index));
