(()=>{
  ...
  style.textContent=`
    ...
    .ct-final-cta-motion:before{
      ...
      z-index:-1;
      border-radius:50%;
      background:radial-gradient(circle,rgba(63,101,255,.2),transparent 68%);
      filter:blur(58px);
      opacity:var(--ct-cta-glow,0);
      transform:translate(-50%,-50%) scale(var(--ct-cta-glow-scale,.72));
      pointer-events:none;
    }
    .ct-final-cta-motion [data-ct-final-cta-part]{
      will-change:transform,opacity,filter;
    }
    @media(prefers-reduced-motion:reduce){
      .ct-final-cta-motion [data-ct-final-cta-part]{opacity:1!important;transform:none!important;filter:none!important}
      .ct-final-cta-motion:before{opacity:.28!important;transform:translate(-50%,-50%) scale(1)!important}
    }
  `;
