(()=>{
  if(document.documentElement.dataset.ctMobileHistoryFix)return;
  document.documentElement.dataset.ctMobileHistoryFix='1';

  const style=document.createElement('style');
  style.dataset.ctMobileHistoryFix='1';
  style.textContent=`
    @media(max-width:900px){
      ...
      #history .large-avatar{
        width:54px!important;
        height:54px!important;
      }
      #history .customer-side h4{
      ...
      #history .timeline-row{
        grid-template-columns:14px 56px minmax(0,1fr)!important;
        gap:10px!important;
        width:100%!important;
        min-width:0!important;
        min-height:0!important;
