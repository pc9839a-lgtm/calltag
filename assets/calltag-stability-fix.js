  ...
  const installStyles=()=>{
    ...
    style.textContent=`
      ...
      @media(max-width:900px){
        html,body{overflow-x:hidden!important}body{padding-bottom:calc(82px + env(safe-area-inset-bottom))!important}
        ...
        .section-copy,.ad-copy,.feature-copy p,.ct-j-copy p,.ct-h-copy p,.ct-auto-message-copy p{font-size:14px!important;line-height:1.65!important}.today-main p,.timeline-content p,.ct-price-card li,.ad-price li,.price-list div{font-size:12px!important;line-height:1.5!important}.today-main strong,.timeline-content strong{font-size:13px!important;line-height:1.4!important}.ui-action{min-height:44px!important;font-size:12px!important;padding:0 8px!important}.calendar-label{font-size:10px!important}.calendar-day{min-height:52px!important;font-size:11px!important}.calendar-event{width:9px!important;height:9px!important;margin-top:7px!important}.detail-meta span,.summary-cell span{font-size:10px!important}.detail-meta b,.summary-cell b{font-size:11px!important}.ct-price-card li,.ad-price li{min-height:18px!important}
        .ct-horizontal-industries .ct-h-track,.ct-journey-horizontal .ct-j-track{scroll-behavior:smooth;overscroll-behavior-x:contain;-webkit-overflow-scrolling:touch}.ct-horizontal-industries .ct-h-panel,.ct-journey-horizontal .ct-j-panel{scroll-snap-stop:always}
      }
      @media(max-width:420px){.section-copy,.ad-copy,.feature-copy p,.ct-j-copy p,.ct-h-copy p{font-size:13px!important}.today-main p,.timeline-content p,.ct-price-card li,.ad-price li{font-size:11px!important}.ui-action{font-size:11px!important}.calendar-label{font-size:9px!important}.calendar-day{font-size:10px!important}}
    `;
