...
.ct-sec-qr-wrap{display:grid;place-items:center;margin:4px auto 14px;padding:14px;width:232px;max-width:100%;min-height:232px;border:1px solid #e2e8f0;border-radius:18px;background:#fff;overflow:hidden}.ct-sec-qr{width:204px;height:204px;max-width:100%;display:grid;place-items:center;overflow:hidden}.ct-sec-qr canvas,.ct-sec-qr img{display:block!important;width:204px!important;height:204px!important;max-width:100%;object-fit:contain}.ct-sec-qr img{display:none!important}.ct-sec-qr-fallback{font-size:13px;line-height:1.55;text-align:center;color:#64748b;padding:18px}
