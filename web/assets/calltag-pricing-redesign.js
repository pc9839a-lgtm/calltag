    ...
    if(!document.querySelector('style[data-ct-pricing-redesign]')){
      ...
      style.textContent=`
        ...
        @media(max-width:900px){
          #pricing.ct-pricing-redesign{padding:88px 0!important}
          .ct-pricing-grid{grid-template-columns:1fr}
          .ct-plan-card{min-height:0;padding:27px}
          .ct-plan-price b{font-size:46px}
        }
        @media(max-width:600px){
          .ct-pricing-head{margin-bottom:32px}.ct-pricing-head h2{font-size:39px}.ct-pricing-head>strong{font-size:13px;line-height:1.5}
          .ct-plan-card{padding:24px 20px;border-radius:20px}
          .ct-plan-top{display:block}.ct-plan-price{margin-top:25px;text-align:left}.ct-plan-price b{font-size:43px}.ct-plan-top h3{font-size:31px}
          .ct-plan-card>p{margin-top:21px;font-size:14px}.ct-plan-card ul{grid-template-columns:1fr;margin-top:22px}.ct-plan-card li{min-height:48px;font-size:12px}
          .ct-plan-badge{top:18px;right:18px;font-size:9px}
        }
      `;
