  ...
  const run=()=>{
    ...
    if(!q('style[data-ct-interaction-fix]')){
      ...
      style.textContent=`
        ...
        #app .step-item:hover b,#app .step-item:focus-visible b{background:var(--blue);color:#fff;box-shadow:0 0 0 8px rgba(59,111,255,.11)}
        #targets .ad-head{max-width:none!important}
        #targets .ad-title{white-space:nowrap!important;font-size:clamp(42px,5.2vw,76px)!important}
        #targets .ct-marquee-viewport{position:relative!important;display:block!important;width:100%!important;max-width:none!important;margin:0!important;overflow:hidden!important;scroll-snap-type:none!important;scrollbar-width:none!important;mask-image:linear-gradient(90deg,transparent 0,#000 7%,#000 93%,transparent 100%);-webkit-mask-image:linear-gradient(90deg,transparent 0,#000 7%,#000 93%,transparent 100%)}
        #targets .ct-marquee-rail{display:flex;width:max-content;will-change:transform;animation:ctIndustryFlow 34s linear infinite}
        #targets .ct-marquee-viewport:hover .ct-marquee-rail{animation-play-state:paused}
        #targets .ct-marquee-group{display:flex;flex:none;gap:20px;padding-right:20px}
        #targets .ct-marquee-group .ad-target{flex:0 0 clamp(420px,42vw,650px)!important;width:clamp(420px,42vw,650px)!important;min-height:330px!important;padding:48px 52px!important;border-radius:27px!important;display:flex!important;flex-direction:column!important;justify-content:center!important;scroll-snap-align:none!important}
        #targets .ct-marquee-group .ad-target span{font-size:13px!important}
