export default {
  async fetch(request, env) {
    ...
    if (!body.includes('/assets/calltag-enhance.css')) {
      body = body.replace('</head>', '<link rel="stylesheet" href="/assets/calltag-enhance.css?v=20260731-7" /></head>');
    }
    if (!body.includes('/assets/calltag-enhance.js')) {
      body = body.replace('</body>', '<script src="/assets/calltag-enhance.js?v=20260731-7"></script><script src="/assets/calltag-copy-fix.js?v=20260731-7"></script></body>');
    }
